...
import { asyncRoutes, constantRoutes, energyRouters, reportTableRouters, platSettingRouters, smartDiagnoseRouters, smartTableRouters } from '@/router'
...
const mutations = {
  SET_ROUTES: (state, routes) => {
    ...
    state.smartTableRoutes = smartTableRouters
  }
}
