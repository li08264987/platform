...
<script>
import firstFloor from '@/views/project/monitor/yongneng/shopOne/firstFloor'
import secFloor from '@/views/project/monitor/yongneng/shopOne/secFloor'
import thirdFloor from '@/views/project/monitor/yongneng/shopOne/thirdFloor'
import forthFloor from '@/views/project/monitor/yongneng/shopOne/forthFloor'
import fifthFloor from '@/views/project/monitor/yongneng/shopOne/fifthFloor'
