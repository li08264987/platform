...
import system from '@/views/project/dataentry/gongneng/qingdan/system'
// import groupAone from '@/views/project/dataentry/gongneng/qingdan/groupAone'
// import groupAtwo from '@/views/project/dataentry/gongneng/qingdan/groupAtwo'
// import groupBone from '@/views/project/dataentry/gongneng/qingdan/groupBone'
// import groupBtwo from '@/views/project/dataentry/gongneng/qingdan/groupBtwo'
export default {
  name: 'MonitorView',
  components: {
    runInfo,
