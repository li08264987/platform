...
import systemOne from '@/views/project/dataentry/gongneng/zhenkong/systemone'
import systemTwo from '@/views/project/dataentry/gongneng/zhenkong/systemtwo'
import systemFive from '@/views/project/dataentry/gongneng/zhenkong/systemfive'
// import fgroupone from '@/views/project/dataentry/gongneng/zhenkong/fgroupone'
// import fgrouptwo from '@/views/project/dataentry/gongneng/zhenkong/fgrouptwo'
// import fgroupthree from '@/views/project/dataentry/gongneng/zhenkong/fgroupthree'
// import fgroupfour from '@/views/project/dataentry/gongneng/zhenkong/fgroupfour'
// import sgroupone from '@/views/project/dataentry/gongneng/zhenkong/sgroupone'
// import sgrouptwo from '@/views/project/dataentry/gongneng/zhenkong/sgrouptwo'
// import figroupone from '@/views/project/dataentry/gongneng/zhenkong/figroupone'
// import figrouptwo from '@/views/project/dataentry/gongneng/zhenkong/figrouptwo'
export default {
  name: 'MonitorView',
  components: {
    runInfo,
