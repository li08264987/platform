  ...
  <div class="rules">
    <el-dialog title="报警规则" :visible.sync="dialogTableVisible">
      ...
      <el-table :data="gridData">
        ...
        <el-table-column property="name" label="报警名称" ></el-table-column>
        <el-table-column property="level" label="级别"></el-table-column>
        <el-table-column property="value" label="设定值"></el-table-column>
        ...
        <el-table-column property="operate" label="操作选项">
          <template slot-scope="scope">
            <el-button type="text" size="small" style="text-decoration:underline;">编辑</el-button>
