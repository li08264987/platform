...
<script>
import CurveChart from '@/views/project/smartTable/zhenkong/pertimeChart/curveChart'
import TableChart from '@/views/project/smartTable/zhenkong/pertimeChart/tableChart'
const lineChartData = {
  newVisitis: {
