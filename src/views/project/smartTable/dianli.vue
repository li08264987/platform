...
<script>
import MainTable from '@/views/project/smartTable/dianli/mainTable'
import HistoryDialog from '@/views/project/smartTable/dianli/historyDialog'
import PerTimeDialog from '@/views/project/smartTable/dianli/perTimeDialog'
