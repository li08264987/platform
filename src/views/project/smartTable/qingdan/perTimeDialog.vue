...
<script>
import CurveChart from '@/views/project/smartTable/qingdan/pertimeChart/curveChart'
import TableChart from '@/views/project/smartTable/qingdan/pertimeChart/tableChart'
const lineChartData = {
  newVisitis: {
