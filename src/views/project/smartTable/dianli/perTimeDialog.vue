...
<script>
import CurveChart from '@/views/project/smartTable/dianli/pertimeChart/curveChart'
import TableChart from '@/views/project/smartTable/dianli/pertimeChart/tableChart'
const lineChartData = {
  newVisitis: {
