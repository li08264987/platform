...
<script>
import MainTable from '@/views/project/smartTable/qingdan/mainTable'
import HistoryDialog from '@/views/project/smartTable/qingdan/historyDialog'
import PerTimeDialog from '@/views/project/smartTable/qingdan/perTimeDialog'
