<template>
  <div class="zhenkong-container">
    ...
    <div>
      <history-dialog :show.sync="showHistory" :title="title" :variable="variable" @historyDialogClose="historyDialogClose" />
    </div>
...
<script>
import MainTable from '@/views/project/smartTable/zhenkong/mainTable'
import HistoryDialog from '@/views/project/smartTable/zhenkong/historyDialog'
import PerTimeDialog from '@/views/project/smartTable/zhenkong/perTimeDialog'
